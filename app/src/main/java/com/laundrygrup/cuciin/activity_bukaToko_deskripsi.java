...
public class activity_bukaToko_deskripsi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buka_toko_deskripsi);
    ...
    private void init(){
        ...
        inputDeskripsi =findViewById(R.id.et_deskripsi);
    ...
    private void inputJasa(){
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(inputDeskripsi.getText().toString().equals("")){
                    Toast.makeText(activity_bukaToko_deskripsi.this,"Data kosong!",Toast.LENGTH_SHORT).show();
                }
                else {
                    cekPunyaToko();
                    finish();
    ...
    private void updateLastId(){
        reference.child("data").child("idToko").setValue(new dataToko.idToko(Integer.toString(tambahId)))
                .addOnSuccessListener(activity_bukaToko_deskripsi.this, new OnSuccessListener<Void>() {
                    @Override
    ...
    private void buatToko(){
        ...
        reference.child("Toko").child(kodeToko).setValue(new dataToko(kodeToko,"","","","",inputDeskripsi.getText().toString(),""))
                .addOnSuccessListener(activity_bukaToko_deskripsi.this, new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        tokoBaruKeUser();
    ...
    private void editJasa(){
        dataToko.deskripsi deskripsi=new dataToko.deskripsi(inputDeskripsi.getText().toString());
        reference.child("Toko").child(cekKodeToko.getKodeToko()).updateChildren(deskripsi.toMap())
                .addOnSuccessListener(activity_bukaToko_deskripsi.this, new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                    }
