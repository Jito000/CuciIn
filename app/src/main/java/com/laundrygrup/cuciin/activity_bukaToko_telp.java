...
public class activity_bukaToko_telp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buka_toko_telp);
    ...
    private void init(){
        ...
        inputNoHp =findViewById(R.id.et_telp);
    ...
    private void inputJasa(){
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(inputNoHp.getText().toString().equals("")){
                    Toast.makeText(activity_bukaToko_telp.this,"Data kosong!",Toast.LENGTH_SHORT).show();
                }
                else {
                    cekPunyaToko();
                    finish();
    ...
    private void updateLastId(){
        reference.child("data").child("idToko").setValue(new dataToko.idToko(Integer.toString(tambahId)))
                .addOnSuccessListener(activity_bukaToko_telp.this, new OnSuccessListener<Void>() {
                    @Override
    ...
    private void buatToko(){
        ...
        reference.child("Toko").child(kodeToko).setValue(new dataToko(kodeToko,"","","",inputNoHp.getText().toString(),"",""))
                .addOnSuccessListener(activity_bukaToko_telp.this, new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        tokoBaruKeUser();
    ...
    private void editJasa(){
        dataToko.noTelp telp=new dataToko.noTelp(inputNoHp.getText().toString());
        reference.child("Toko").child(cekKodeToko.getKodeToko()).updateChildren(telp.toMap())
                .addOnSuccessListener(activity_bukaToko_telp.this, new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                    }
